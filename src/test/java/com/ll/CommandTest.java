...
public class CommandTest {
    ...
    @Test
    @DisplayName("cmd.getParam(\"id\") == 10")
    public void t2() {
        Command cmd = new Command("삭제?id=10");
    ...
    @Test
    @DisplayName("cmd.getParam(\"number\") == null")
    public void t3() {
        Command cmd = new Command("삭제?id=10");
    ...
    @Test
    @DisplayName("cmd.getParam(\"number\", \"-\") == \"-\"")
    public void t4() {
        Command cmd = new Command("삭제?id=10");
    ...
    @Test
    @DisplayName("cmd.getParamAsInt(\"id\", 0) == 10")
    public void t5() {
        Command cmd = new Command("삭제?id=10");
    ...
    @Test
    @DisplayName("cmd.getParamAsInt(\"number\", 0) == 0")
    public void t6() {
        Command cmd = new Command("삭제?id=10");
